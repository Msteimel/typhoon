...
var accordionShowAnimations = [];
var accordionHideAnimations = [];

function handleAccordionClick(e) {
  var accordionItem = e.currentTarget;
  var button = accordionItem.querySelector('.lib-accordion--title');
  var content = accordionItem.querySelector('.lib-accordion--content');
...
accordionItems.forEach(function (item) {
  var contentEl = item.querySelector('.lib-accordion--content');
  ...
  accordionShowAnimations[contentNum] = Object(animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
    targets: contentEl,
  ...
  accordionHideAnimations[contentNum] = Object(animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
    targets: contentEl,
    height: 0,
    autoplay: false,
    easing: 'linear',
